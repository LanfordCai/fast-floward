      ...
      const transactionId = await fcl.send([
        fcl.transaction`
          ...
          transaction(listingIndex: Int) {
              ...
              let listings: [LocalArtistMarket.Listing]
              ...
              prepare(account: AuthAccount) {
                  ...
                  self.listings = self.marketRef.getListings()
              }
              ...
              execute {
                  let sentVault <- self.vaultRef.withdraw(amount: self.listings[listingIndex].price)
                  self.marketRef.buy(listing: listingIndex, with: <- sentVault, buyer: self.buyer)
              }
          }
        `,
        fcl.args([
