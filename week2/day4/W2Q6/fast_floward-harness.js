    ...
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="DAY 4: Kitty Items Market - Sell Market Item"
          description="Sell a Kitty Item" action="kittyItemsMarketSellMarketItem" method="post"
        ...
        <action-card title="DAY 4: Kitty Items Market - Buy Market Item"
          description="Buy a Kitty Item" action="kittyItemsMarketBuyMarketItem" method="post"
        ...
        <action-card title="DAY 4: Kitty Items Market - Read Sale Collection IDs"
          description="Read the ids of NFTs for sale in this account" action="kittyItemsMarketReadSaleCollectionIDs"
