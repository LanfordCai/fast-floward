...
pub contract RegistryNFTContract: NonFungibleToken, RegistryInterface {
    ...
    pub resource NFT: NonFungibleToken.INFT {
        ...
        init(_tenant: &Tenant{ITenant}, _metadata: {String: String}) {
    ...
    pub resource NFTMinter {
        ...
        //
        pub fun mintNFT(tenant: &Tenant{ITenant}, recipient: &RegistryNFTContract.Collection{NonFungibleToken.CollectionPublic}, metadata: {String: String}) {
